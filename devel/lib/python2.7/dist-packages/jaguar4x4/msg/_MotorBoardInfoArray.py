...
"""autogenerated by genpy from jaguar4x4/MotorBoardInfoArray.msg. Do not edit."""
import sys
...
class MotorBoardInfoArray(genpy.Message):
  ...
  _type = "jaguar4x4/MotorBoardInfoArray"
...
"""
  ...
  _slot_types = ['jaguar4x4/MotorBoardInfo[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = jaguar4x4.msg.MotorBoardInfo()
        _v3 = val1.header
        start = end
        end += 4
