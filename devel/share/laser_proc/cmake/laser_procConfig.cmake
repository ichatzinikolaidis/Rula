...
if("TRUE" STREQUAL "TRUE")
  set(laser_proc_SOURCE_PREFIX /home/iordanis/Roula/src/laser_proc)
  set(laser_proc_DEVEL_PREFIX /home/iordanis/Roula/devel)
  ...
  set(laser_proc_INSTALL_PREFIX /home/iordanis/Roula/install)
...
if(NOT "/home/iordanis/Roula/src/laser_proc/include " STREQUAL " ")
  set(laser_proc_INCLUDE_DIRS "")
  set(_include_dirs "/home/iordanis/Roula/src/laser_proc/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'laser_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/iordanis/Roula/src/laser_proc/${idir}'.  Ask the maintainer 'Chad Rockey <chadrockey@willowgarage.com>' to fix it.")
    endif()
