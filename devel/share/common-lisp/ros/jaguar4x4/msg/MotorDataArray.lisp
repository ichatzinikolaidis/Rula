...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MotorDataArray>)))
  ...
  (cl:format cl:nil "#this message will be used for motor data infor~%MotorData[] motorData~%~%================================================================================~%MSG: jaguar4x4/MotorData~%#motor sensor data message from Dr Robot ~%Header header 	   #timestamp in the header is the time the driver~%int64 motorPower	   # motor driver power from motor driver board~%int64 encoderPos	   #encoder position reading~%int64 encoderVel	   #encoder velocity reading~%int64 encoderDiff	   #encoder position differnece reading referee last reading~%float32 motorTemp   #motor temperature reading~%float32 motorCurrent	  #motor current feedback reading~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MotorDataArray)))
  "Returns full string definition for message of type 'MotorDataArray"
  (cl:format cl:nil "#this message will be used for motor data infor~%MotorData[] motorData~%~%================================================================================~%MSG: jaguar4x4/MotorData~%#motor sensor data message from Dr Robot ~%Header header 	   #timestamp in the header is the time the driver~%int64 motorPower	   # motor driver power from motor driver board~%int64 encoderPos	   #encoder position reading~%int64 encoderVel	   #encoder velocity reading~%int64 encoderDiff	   #encoder position differnece reading referee last reading~%float32 motorTemp   #motor temperature reading~%float32 motorCurrent	  #motor current feedback reading~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
